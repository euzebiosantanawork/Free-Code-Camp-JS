...
// The above function can be re-written using multiple conditionaonal opratord:
...
function findGreaterorEqual( a, b ) {
  ...
  such that each condition is on a separate line, as shown above. Using multiple
