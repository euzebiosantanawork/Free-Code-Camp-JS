...
vvariable declarations without an error
*/
...
issue with the var keyword. If you were to replace var with let in the 
variable declarations of the code above, the result would be an error.
*/
...
can only be declared once. Note the "use strict". This enables Strict Mode, 
